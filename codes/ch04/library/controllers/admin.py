...
def add_books(book: BookReq):
    book = Book(classification=book.classification, year_published=book.year_published, edition=book.edition,
                author=book.author, title=book.title, book_id=book.book_id)
