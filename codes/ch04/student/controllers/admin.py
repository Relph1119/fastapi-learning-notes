...
def signup_students(signup: SignupReq):
    account: Signup = Signup(stud_id=signup.stud_id, username=signup.username, password=signup.password,
...
def approved_signup(sign_id: int):
    ...
    if not account == None:
        login = Login(user_id=account.sign_id, stud_id=account.stud_id, username=account.username,
