...
class Student:
    def __init__(self, stud_id: int, fname: str, lname: str, mname: str, age: int, major: Major, department: str,
    ...
    def __repr__(self):
        return ' '.join(
            [str(self.stud_id), self.lname, self.mname, self.lname, str(self.age), self.course, self.status])
