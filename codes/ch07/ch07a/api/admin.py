...
def add_signup(req: SignupReq, credentials: HTTPBasicCredentials = Depends(http_basic),
...
def update_signup(id: int, req: SignupReq, credentials: HTTPBasicCredentials = Depends(http_basic),
                  sess: Session = Depends(sess_db)):
