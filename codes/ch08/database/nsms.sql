...
ALTER TABLE ONLY public.admin
    ADD CONSTRAINT fk_admin_login FOREIGN KEY (login_id) REFERENCES public.login(id) ON
UPDATE RESTRICT
ON
DELETE
RESTRICT;
...
ALTER TABLE ONLY public.billing
    ADD CONSTRAINT fk_billing_admin1 FOREIGN KEY (admin_id) REFERENCES public.admin(id) ON
UPDATE RESTRICT
ON
DELETE
RESTRICT;
...
ALTER TABLE ONLY public.billing
    ADD CONSTRAINT fk_billing_vendor1 FOREIGN KEY (vendor_id) REFERENCES public.vendor(id) ON
UPDATE RESTRICT
ON
DELETE
RESTRICT;
...
ALTER TABLE ONLY public.content
    ADD CONSTRAINT fk_content_publication1 FOREIGN KEY (publication_id) REFERENCES public.publication(id) ON
UPDATE RESTRICT
ON
DELETE
RESTRICT;
...
ALTER TABLE ONLY public.customer
    ADD CONSTRAINT fk_customer_login1 FOREIGN KEY (login_id) REFERENCES public.login(id) ON
UPDATE RESTRICT
ON
DELETE
RESTRICT;
...
ALTER TABLE ONLY public.sales
    ADD CONSTRAINT fk_issues_publication1 FOREIGN KEY (publication_id) REFERENCES public.publication(id) ON
UPDATE RESTRICT
ON
DELETE
RESTRICT;
...
ALTER TABLE ONLY public.messenger
    ADD CONSTRAINT fk_messenger_vendor1 FOREIGN KEY (vendor_id) REFERENCES public.vendor(id) ON
UPDATE RESTRICT
ON
DELETE
RESTRICT;
...
ALTER TABLE ONLY public.publication
    ADD CONSTRAINT fk_publication_messenger1 FOREIGN KEY (messenger_id) REFERENCES public.messenger(id) ON
UPDATE RESTRICT
ON
DELETE
RESTRICT;
...
ALTER TABLE ONLY public.publication
    ADD CONSTRAINT fk_publication_vendor1 FOREIGN KEY (vendor_id) REFERENCES public.vendor(id) ON
UPDATE RESTRICT
ON
DELETE
RESTRICT;
...
ALTER TABLE ONLY public.subscription
    ADD CONSTRAINT fk_subscription_customer1 FOREIGN KEY (customer_id) REFERENCES public.customer(id) ON
UPDATE RESTRICT
ON
DELETE
RESTRICT;
...
ALTER TABLE ONLY public.vendor
    ADD CONSTRAINT fk_vendor_login1 FOREIGN KEY (login_id) REFERENCES public.login(id) ON
UPDATE RESTRICT
ON
DELETE
RESTRICT;
