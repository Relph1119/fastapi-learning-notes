...
async def add_feedback(req: FeedbackReq, id: int, engine=Depends(create_db_engine),
...
async def add_ambiance_rate(req: AmbianceRateReq, id: int, engine=Depends(create_db_engine),
                            user: str = Depends(get_current_user)):
...
async def add_food_rate(req: FoodRateReq, id: int, engine=Depends(create_db_engine),
                        user: str = Depends(get_current_user)):
